...
export const GetDocumentFolderResponse = zod.object({
  ...
  "canView": zod.boolean().describe('Whether the current user may view documents in this folder'),
  "canUpload": zod.boolean().describe('Whether the current user may upload documents to this folder'),
  "canApprove": zod.boolean().describe('Whether the current user may approve\/reject documents in this folder'),
  "canManage": zod.boolean().describe('Whether the current user may manage (edit\/delete) this folder'),
