...
export type AuditAction =
  ...
  | "DOCUMENT_DOWNLOADED"
  | "DOCUMENT_VIEWED"
  | "ACCESS_MATRIX_UPDATED"
  | "ACCESS_MATRIX_PERMISSION_GRANTED"
  | "ACCESS_MATRIX_PERMISSION_REVOKED"
  | "DOMAIN_PROTECTION_BLOCKED"
  | "DOCUMENT_ACCESS_DENIED"
  | "DOCUMENT_NOTICE_ACCEPTED"
  | "DOCUMENT_NOTICE_RESET"
  | "MEMBER_CREATED"
  | "MEMBER_DELETED"
  | "DELETE_BLOCKED"
  | "INVITATION_SENT"
