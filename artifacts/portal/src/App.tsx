  ...
  return (
    <BootstrapCheck>
      <Switch>
        ...
        <Route path="/admin/document-review" component={() => <ProtectedRoute component={AdminDocumentReviewPage} minLevel={ADMIN_LEVEL} />} />
        <Route path="/admin/reports" component={() => <ProtectedRoute component={AdminReportsPage} minLevel={ADMIN_LEVEL} />} />
